...
const com = {
	simple: `${mainDir} ${fileName} --lib=react --type=pure`,
	withTest: `${mainDir} ${fileName} --lib=react --type=pure --include=test`,
	withFlow: `${mainDir} ${fileName} --lib=react --type=pure --include=test,flow`,
	withRedux: `${mainDir} ${fileName} --lib=react --type=pure --include=test,redux`,
	withFlowAndRedux: `${mainDir} ${fileName} --lib=react --type=pure --include=test,redux,flow`
};
